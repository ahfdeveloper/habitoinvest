...
class AppPages{
  static final routes = [
    GetPage(name: Routes.SPLASH, page: () => SplashScreenPage(), binding: SplashScreenBinding()),
    ...
    GetPage(name: Routes.INCOME_ADDUPDATE, page: () => IncomeAddUpdatePage()),
    ...
    GetPage(name: Routes.PARAMETERS, page: () => ParametersPage()),
  ];
}