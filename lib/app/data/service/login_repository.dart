...
class LoginRepository {
  ...
  Future addUserFirestore({required String userUid, required String name, required String email}) async {
  ...
  verifyUserInBD({required String userUid, required String name, required String email}) {
