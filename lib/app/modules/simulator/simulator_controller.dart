...
class SimulatorController extends GetxController {
  ...
  final MoneyMaskedTextController contributionValueController = MoneyMaskedTextController(
    leftSymbol: 'R\$ ', decimalSeparator: ',', thousandSeparator: '.',
  );
  final MoneyMaskedTextController interestRateController = MoneyMaskedTextController(
    decimalSeparator: ',', thousandSeparator: '.', rightSymbol: ' %',
  );
  final TextEditingController aplicationDeadlineController = TextEditingController();
